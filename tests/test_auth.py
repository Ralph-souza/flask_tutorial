...
def test_register(client, app):
    ...
    # will have  a Location with the login URL when the register view redirects to the login view
...
def test_logout(client, auth):
    ...
    with client:
        ...
        # Normally, accessing session outside a request would raise an error
